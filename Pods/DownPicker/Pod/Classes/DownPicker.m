...
{
    return [self initWithTextField:tf withData:nil withPlaceHolder:@"Tap to pick ..."];
}
...
- (IBAction)showPicker:(id)sender
{
    ...
    pickerView.backgroundColor = BEIGE_COLOR;
    ...
    [button setTitle:self->toolbarDoneButtonText forState:UIControlStateNormal];
    ...
    if (self.shouldDisplayCancelButton) {
        UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
        [button setTitle:self->toolbarCancelButtonText forState:UIControlStateNormal];
        [button setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        button.frame=CGRectMake(0.0, 0.0, 60.0, 30.0);
